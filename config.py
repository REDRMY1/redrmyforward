...
API_ID = int(os.environ.get("API_ID", "36725347"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "73682b8b221e89239e9176f321044992")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8161486573"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Redrmy:redrmy@632008@cluster0.apgrlgv.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "redrmy")
